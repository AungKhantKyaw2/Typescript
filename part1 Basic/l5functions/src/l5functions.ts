...
console.log(car("suzuki",2,100));


                                                // Nousedparameter true
let truck = (brand:string,qty:number,tax:number,discount:number):number=>{
    let price:number=0;
    let result:number =0; //nousedlocals:"true"
    if(brand ==="toyota") price=3000;
    if(brand ==="mazda") price=2000;
    if(brand ==="suzuki") price=1000;
...
console.log(truck("toyota",1,100,19));
console.log(truck("mazda",2,100,10));
console.log(truck("suzuki",2,100,11));
